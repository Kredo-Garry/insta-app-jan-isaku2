...
@section('titile', 'Admin: Categories')
                    ...
                    @forelse ($all_categories as $category)
                        <tr>
                            ...
                            <td>
                                ...
                                {{-- Delete Button --}}
                                <button class="btn btn-outline-danger btn-sm" data-bs-toggle="modal" data-bs-target="#delete-category-{{ $category->id }}" title="Delete"><i class="fa-solid fa-trash-can"></i></button>
                            </td>
                        </tr>
