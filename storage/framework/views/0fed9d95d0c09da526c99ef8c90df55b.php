            ...
            <div class="modal-content border-warning">
                <div class="modal-header border-warning">
                    <h3 class="h5 modal-title">
                        <i class="fa-regular fa-pen-to-square"> Edit Category</i>
                    </h3>
                </div>
        ...
        <form action="<?php echo e(route('admin.categories.destroy', $category->id)); ?>" method="post">
            ...
            <div class="modal-content border-danger">
                <div class="modal-header border-danger">
                    <h3 class="h5 modal-title">
                        <i class="fa-regular fa-pen-trash-can"> Delete Category</i>
                    </h3>
                </div>
                <div class="modal-body">
                    <p>Are you sure you want to delete <span class="fw-bold"><?php echo e($category->name); ?></span> category?</p>
                    <p class="fw-light">This action will affect all the posts under category. Posts without category will fall under uncategorized.</p>
...
</div><?php /**PATH /Applications/MAMP/htdocs/insta-app/resources/views/admin/categories/modal/action.blade.php ENDPATH**/ ?>